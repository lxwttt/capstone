#ifndef _NEW_ARMOR_TRACKER__INTERFACE__ANTITOPV3_H_
#define _NEW_ARMOR_TRACKER__INTERFACE__ANTITOPV3_H_
...
#include "new_armor_tracker/kalman/filter/kf.h"
#include "new_armor_tracker/utils/slidestd.hpp"
#include "new_armor_tracker/utils/slideweighted.hpp"
...
class AntitopV3
{
   public:
    ...
    double getTheta() { return omega_model_.estimate_X[0]; };
    ...
    void getStatus(auto_aim_interfaces::msg::NewTarget &msg);
