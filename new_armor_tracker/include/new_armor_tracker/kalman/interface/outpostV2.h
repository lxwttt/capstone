#ifndef __NEW_ARMOR_TRACKER__INTERFACE__OUTPOSTV2_H__
#define __NEW_ARMOR_TRACKER__INTERFACE__OUTPOSTV2_H__
...
public:
    ...
    void getStatus(auto_aim_interfaces::msg::NewTarget& _msg);
