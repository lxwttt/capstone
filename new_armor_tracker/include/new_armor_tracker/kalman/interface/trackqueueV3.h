#ifndef __NEW_ARMOR_TRACKER__INTERFACE__TRACKQUEUEV3_H__
#define __NEW_ARMOR_TRACKER__INTERFACE__TRACKQUEUEV3_H__
#include <memory>
#include <vector>
...
public:
    ...
    void getStatus(auto_aim_interfaces::msg::NewTarget& _msg);                       // 获取目标状态信息
