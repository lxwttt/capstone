...
void OutpostV2::getStatus(auto_aim_interfaces::msg::NewTarget &_msg)
{
    ...
    _msg.center_model_position.x = 0;
    _msg.center_model_position.y = 0;
    _msg.center_model_velocity.x = 0;
    _msg.center_model_velocity.y = 0;

    _msg.z1 = 0;
    _msg.z2 = 0;

    _msg.r1 = OUTPOST_R_V2;
    _msg.r2 = OUTPOST_R_V2;

    _msg.yaw   = model_.estimate_X[3];
    _msg.omega_v_yaw = omega_.getAvg() > 0 ? OUTPOST_OMEGA_V2 : -OUTPOST_OMEGA_V2;
}
...
{
    model_.Q << q0, 0, 0, 0, 0, 0, 0, 0, 0, q1, 0, 0, 0, 0, 0, 0, 0, 0, q2, 0, 0, 0, 0, 0, 0, 0, 0, q3, 0, 0, 0, 0, 0, 0, 0, 0, q4, 0, 0, 0, 0, 0, 0,
        0, 0, q5, 0, 0, 0, 0, 0, 0, 0, 0, q6, 0, 0, 0, 0, 0, 0, 0, 0, q7;
}

void OutpostV2::setMatrixR(double r0, double r1, double r2, double r3) { model_.R << r0, 0, 0, 0, 0, r1, 0, 0, 0, 0, r2, 0, 0, 0, 0, r3; }

void OutpostV2::setMatrixOmegaQ(double q0, double q1) { omega_model_.Q << q0, 0, 0, q1; }

void OutpostV2::setMatrixOmegaR(double r0) { omega_model_.R << r0; }
